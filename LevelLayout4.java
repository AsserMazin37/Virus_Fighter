...
import gameData.Virus;
		...
		public class LevelLayout4 extends ScreenAdapter{
			...
			LevelLayout4(final VirusFighter game){
				...
				//v= new Rectangle(virusx,virusy,virus.getWidth(),virus.getHeight());
				l = new Level4();
				v = new Virus();
			...
			public void render (float delta) {
				...
				game.batch.draw(background, 0, 0, Gdx.graphics.getWidth()*20, Gdx.graphics.getHeight()*20);
		    	...
		    	while(counter < bulletManager.size()) {
		    		...
		    		if(currentBullet.bulletLocation.x > -110 && currentBullet.bulletLocation.x < Gdx.graphics.getWidth() && currentBullet.bulletLocation.y > -40 && currentBullet.bulletLocation.y < Gdx.graphics.getHeight()) {
		    			...
		    			bulletCircle.add(new Circle(currentBullet.bulletLocation.x+113,currentBullet.bulletLocation.y+75,10));
		    			 //sr.circle(currentBullet.bulletLocation.x+113,currentBullet.bulletLocation.y+75,10);
		    		}
		    		else {
				...
				s= new Circle(spaceShipLoc.x+110,spaceShipLoc.y+65,spaceShip.getWidth()/40);
		     	if(Gdx.input.isKeyPressed(Keys.UP) && (spaceShipLoc.y < Gdx.graphics.getHeight() - spaceShip.getHeight() / 5)) {
		    		spaceShipLoc.y += 5;
		    		
		    	}
		    	if(Gdx.input.isKeyPressed(Keys.DOWN) && (spaceShipLoc.y > -30)) {
		    		spaceShipLoc.y -= 5;
		    	...
		    	font.draw(game.batch, String.valueOf(count2),200,200);
			...
			if (vh4<=170)
		    {
		    	...
		    	//sr.circle(virusx+185-70,virusy+105-40,virus.getWidth()/40);
		    	//sr.circle(virusx+185,virusy+105,virus.getWidth()/40);
		    	//sr.circle(spaceShipLoc.x+110,spaceShipLoc.y+65,spaceShip.getWidth()/40);
		    	//sr.end();
