...
public class Level3Layout extends ScreenAdapter{
	ShapeRenderer sr;
	...
	String backToCharacter, backToLevel, restart;
		...
		Level3Layout(final VirusFighter game){
		...
		public void render (float delta) {
			...
			if(instructions) {
		    	...
		    	if(firstVirusKilled && secondVirusKilled) {
		    		...
		    		smallRed.draw(game.batch, congratulationsText, 230, timerLoc.y-40);
		    	...
		    	if(gameLost) {
		    		...
		    		smallRed.draw(game.batch, gameOverText, 230, timerLoc.y-40);
