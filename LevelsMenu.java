...
// TODO Auto-generated method stub
   ...
   public void render(float delta) {
       ...
       //window
       //batch.draw(img2, 85, 260, Gdx.graphics.getWidth()/6, Gdx.graphics.getHeight()/5);
       /*batch.draw(img4, 265, 260, Gdx.graphics.getWidth()/6, Gdx.graphics.getHeight()/5);
       batch.draw(img4, 450, 260, Gdx.graphics.getWidth()/6, Gdx.graphics.getHeight()/5);
       batch.draw(img4, 85, 100, Gdx.graphics.getWidth()/6, Gdx.graphics.getHeight()/5);
       batch.draw(img4, 265, 100, Gdx.graphics.getWidth()/6, Gdx.graphics.getHeight()/5);
       batch.draw(img4, 450, 100, Gdx.graphics.getWidth()/6, Gdx.graphics.getHeight()/5);*/
