...
public class LevelLayout3 extends ScreenAdapter{
	...
	firstHealthBarPartial, secondHealthBarPartial, firstHealthBarEmpty, secondHealthBarEmpty, loser;
	...
	int bulletSpeed, posY, leftWidth, rightWidth, timerCount, firstVirusHealth, secondVirusHealth, totalTime, firstWithCharacter, secondWithCharacter, firstWithBullet, secondWithBullet;
	...
	boolean firstVirusKilled, secondVirusKilled, characterKilled, gameLost, gameWon, levelEnded, instructions;
	...
	IntroText7, IntroText8, IntroText9, nextLevel, noNextLevel, congratulationsText, gameOverText;
	
	
	String backToCharacter, backToLevel, restart;
		...
		LevelLayout3(final VirusFighter game){
			...
			shoot = Gdx.audio.newMusic(Gdx.files.internal("fire.mp3"));
			...
			collision = new Texture("collision.png");
			firstHealthBarFull = new Texture("fullHealthBar.png");
			secondHealthBarFull = new Texture("fullHealthBarInverted.png");
			firstHealthBarSemi = new Texture("semiHealthBar.png");
			secondHealthBarSemi = new Texture("semiHealthBarInverted.png");
			firstHealthBarPartial = new Texture("partialHealthBar.png");
			secondHealthBarPartial = new Texture("partialHealthBarInverted.png");
			firstHealthBarEmpty = new Texture("noHealthBar.png");
			secondHealthBarEmpty = new Texture("noHealthBarInverted.png");
			...
			smallyellow = new BitmapFont (Gdx.files.internal("myfont9yellowsmall.fnt"));
			orangeFont = new BitmapFont (Gdx.files.internal("myfont7orangeMedium.fnt"));
			mediumRed = new BitmapFont (Gdx.files.internal("myfont5red.fnt"));
			healthbar = new BitmapFont (Gdx.files.internal("myfont.fnt"));
			...
			backToCharacter = "Press c to choose another character";
		 ...
		 public void update() {
		    	...
		    	if(!characterKilled && !gameLost && Gdx.input.isKeyJustPressed(Keys.SPACE)) {
		    		shoot.play();
		    		Bullet myBullet = new Bullet(characterLoc, new Vector2(0, bulletSpeed));
		    		bulletManager.add(myBullet);
		    	}
		    	
		    	if(characterKilled && gameLost) {
		...
		public void render (float delta) {
			...
			if(instructions) {
		    	...
		    	if(firstVirusKilled && secondVirusKilled) {
		    		...
		    		smallyellow.draw(game.batch, congratulationsText, 210, timerLoc.y-80);
	            	
		    		smallyellow.draw(game.batch, backToCharacter,150, timerLoc.y-100); 
		    		smallyellow.draw(game.batch, backToLevel,150, timerLoc.y-140);
		    		smallyellow.draw(game.batch, restart,150, timerLoc.y-180); 
		    	...
		    	if(gameLost) {
		    		...
		    		smallyellow.draw(game.batch, gameOverText, 210, timerLoc.y-80);
